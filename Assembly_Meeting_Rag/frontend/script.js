...
const TEMPLATES = {
    summary: '재난과 관련한 회의 내용을 핵심만 브리핑해줘. 주요 안건/결정사항/미결 이슈를 간단히 정리해줘.',
    issue: '429회와 430회 두 회의를 비교해 주요 쟁점이 어떻게 바뀌었는지 분석해줘. 변화 포인트와 리스크를 정리해줘.',
    speaker: '회의에서 다뤄진 주요 법안별 핵심 변화를 정리해줘. 법안별로 변경 포인트, 기대효과, 남은 쟁점을 알려줘.',
    material: '몇 회차에서 어떤 자료를 요구하였는지 알려주세요. 회차별로 요구 주체, 대상 기관, 요구 자료를 구체적으로 정리해줘.',
    next: '430회 회의 내용을 보아 다음 회의에 진행될 안건의 이슈나 준비해야 할 점들이 있다면 이야기해줘.'
};
